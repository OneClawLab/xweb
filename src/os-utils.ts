 ...
 */
export const BASE_SPAWN_OPTIONS: Pick<SpawnOptions, 'shell' | 'windowsHide'> = {
  shell: IS_WIN32,
  windowsHide: true,
};
 ...
 * @param maxBufferMB - Max stdout buffer in MB (default 1)
 */
...
export function spawnCommand(
  ...
  return new Promise((resolve, reject) => {
    ...
    proc.stdout!.on('data', (chunk: Buffer) => {
      ...
      if (stdoutLen <= maxBufferMB * 1024 * 1024) {
